...
export class BaseHubSpot {
  ...
  constructor({
    ...
    const customHeadersEnv = readEnv('HUBSPOT_CUSTOM_HEADERS');
    if (customHeadersEnv) {
...
export declare namespace HubSpot {
  ...
  export type BaseAssociationDefinition = API.BaseAssociationDefinition;
  export type BaseError = API.BaseError;
  export type BaseObjectTypeDefinition = API.BaseObjectTypeDefinition;
  export type BaseOption = API.BaseOption;
  export type BaseProperty = API.BaseProperty;
