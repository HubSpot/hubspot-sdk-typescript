...
export class CustomChannels extends APIResource {
   ...
   * @example
   * ```ts
   * const customChannel = await client.conversations.customChannels.create({
   *   capabilities: {
   *     '0': {},
   *     '1': {},
   *     '2': {},
   ...
   * ```
   */
  create(body: CustomChannelCreateParams, options?: RequestOptions): APIPromise<CustomChannelCreateResponse> {
   ...
   * @example
   * ```ts
   * const customChannel = await client.conversations.customChannels.update('channelId', {
   *   capabilities: {
   *     '0': {},
   *     '1': {},
   *     '2': {},
  ...
  ): APIPromise<CustomChannelUpdateResponse> {
   ...
   * ```
   */
  list(options?: RequestOptions): APIPromise<CustomChannelListResponse> {
   ...
   * ```
   */
  get(channelID: string, options?: RequestOptions): APIPromise<CustomChannelGetResponse> {
    return this._client.get(path`/conversations/v3/custom-channels/${channelID}`, options);
  }
}

export interface CustomChannelCreateResponse {
  id: string;
...
export interface CustomChannelUpdateResponse {
  id: string;
...
export interface CustomChannelListResponse {
  results: Array<CustomChannelListResponse.Result>;
...
export namespace CustomChannelListResponse {
...
export interface CustomChannelGetResponse {
  id: string;
