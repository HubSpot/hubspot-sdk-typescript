...
export class Send extends APIResource {
   ...
   *   await client.events.send.createEventDefinition({
   ...
   * ```ts
   * const property =
   *   await client.events.send.createEventDefinitionProperty(
   *     'eventName',
   ...
   * @example
   * ```ts
   * await client.events.send.deleteEventDefinition('eventName');
   * ```
   */
   ...
   * @example
   * ```ts
   * await client.events.send.deleteEventDefinitionProperty(
   *   'propertyName',
   *   { eventName: 'eventName' },
   * );
   * ```
   ...
   * ```ts
   * const externalBehavioralEventTypeDefinition =
   *   await client.events.send.getEventDefinition('eventName');
   * ```
   */
  getEventDefinition(
    eventName: string,
   ...
   * for await (const externalBehavioralEventTypeDefinition of client.events.send.listEventDefinitions()) {
   *   // ...
   * }
   * ```
   */
   ...
   * @example
   * ```ts
   * await client.events.send.sendEvent({
   *   eventName: 'eventName',
   ...
   * @example
   * ```ts
   * await client.events.send.sendEventBatch({
   *   inputs: [
   *     {
   *       eventName: 'eventName',
   *       properties: { foo: 'string' },
   ...
   * ```ts
   * const externalBehavioralEventTypeDefinition =
   *   await client.events.send.updateEventDefinition(
   *     'eventName',
   *   );
   * ```
   */
   ...
   * ```ts
   * const property =
   *   await client.events.send.updateEventDefinitionProperty(
   *     'propertyName',
   *     { eventName: 'eventName' },
   *   );
   * ```
