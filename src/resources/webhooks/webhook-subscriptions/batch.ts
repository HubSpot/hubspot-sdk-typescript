...
export class Batch extends APIResource {
  ...
  ): APIPromise<WebhookSubscriptionsAPI.BatchResponseJournalFetchResponse> {
  ...
  updateSubscriptions(
    ...
    options?: RequestOptions,
  ): APIPromise<WebhookSubscriptionsAPI.BatchResponseSubscriptionResponse> {
...
export interface BatchUpdateSubscriptionsParams {
  inputs: Array<WebhookSubscriptionsAPI.SubscriptionBatchUpdateRequest>;
}
