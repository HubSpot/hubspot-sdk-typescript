...
- <code><a href="./src/resources/auth/oauth.ts">AccessTokenResponse</a></code>
- <code><a href="./src/resources/auth/oauth.ts">ClientCredentialsTokenResponse</a></code>
...
- <code title="post /oauth/2026-03/token">client.auth.oauth.<a href="./src/resources/auth/oauth.ts">createToken</a>({ ...params }) -> TokenResponseIf</code>
