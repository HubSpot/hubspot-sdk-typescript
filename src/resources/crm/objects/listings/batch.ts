...
export class Batch extends APIResource {
   ...
   *   await client.crm.objects.listings.batch.create({
  ...
  create(
    ...
    return this._client.post('/crm/v3/objects/0-420/batch/create', { body, ...options });
  }
   ...
   * ```ts
   * const batchResponseSimplePublicObject =
   *   await client.crm.objects.listings.batch.update({
  ...
  update(
    ...
    return this._client.post('/crm/v3/objects/0-420/batch/update', { body, ...options });
  }
   ...
   * @example
   * ```ts
   * await client.crm.objects.listings.batch.delete({
   *   inputs: [{ id: 'id' }],
   * });
   * ```
   */
  delete(body: BatchDeleteParams, options?: RequestOptions): APIPromise<void> {
    return this._client.post('/crm/v3/objects/0-420/batch/archive', {
      body,
      ...options,
   ...
   * ```ts
   * const batchResponseSimplePublicObject =
   *   await client.crm.objects.listings.batch.get({
   *     inputs: [{ id: 'id' }],
   *     properties: ['string'],
  ...
  get(params: BatchGetParams, options?: RequestOptions): APIPromise<CRMAPI.BatchResponseSimplePublicObject> {
    ...
    return this._client.post('/crm/v3/objects/0-420/batch/read', { query: { archived }, body, ...options });
  }
   ...
   *   await client.crm.objects.listings.batch.upsert({
   *     inputs: [{ id: 'id', properties: { foo: 'string' } }],
   *   });
   * ```
   */
  upsert(
    ...
    return this._client.post('/crm/v3/objects/0-420/batch/upsert', { body, ...options });
  }
}
