...
export class Listings extends APIResource {
   ...
   *   await client.crm.objects.listings.create({
  ...
  create(
    ...
    return this._client.post('/crm/v3/objects/0-420', { body, ...options });
  }
   ...
   *   await client.crm.objects.listings.update('listingId', {
   *     properties: { foo: 'string' },
   *   });
   * ```
   */
  update(
    ...
    return this._client.patch(path`/crm/v3/objects/0-420/${listingID}`, {
      query: { idProperty },
      body,
      ...options,
    });
  ...
  list(
    ...
    return this._client.getAPIList('/crm/v3/objects/0-420', Page<CrmAPI.SimplePublicObjectWithAssociations>, {
      query,
      ...options,
    });
  }
  ...
  delete(listingID: string, options?: RequestOptions): APIPromise<void> {
    return this._client.delete(path`/crm/v3/objects/0-420/${listingID}`, {
      ...options,
   ...
   *   await client.crm.objects.listings.get('listingId');
   * ```
   */
  get(
    listingID: string,
    ...
    return this._client.get(path`/crm/v3/objects/0-420/${listingID}`, { query, ...options });
  }
   ...
   *   await client.crm.objects.listings.search();
   * ```
   */
  search(
    ...
    return this._client.post('/crm/v3/objects/0-420/search', { body, ...options });
  }
}
