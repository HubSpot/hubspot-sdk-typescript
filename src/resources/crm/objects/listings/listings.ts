...
export class BaseListings extends APIResource {
  static override readonly _key: readonly ['crm', 'objects', 'listings'] = Object.freeze([
    'crm',
    'objects',
    'listings',
  ] as const);
   ...
   * provided.
   */
  create(body: ListingCreateParams, options?: RequestOptions): APIPromise<CrmAPI.SimplePublicObject> {
    return this._client.post('/crm/objects/2026-03/0-420', { body, ...options });
  }
  ...
  update(
    ...
    return this._client.patch(path`/crm/objects/2026-03/0-420/${listingID}`, {
      query: { idProperty },
      body,
      ...options,
    });
   ...
   */
  delete(listingID: string, options?: RequestOptions): APIPromise<void> {
    return this._client.delete(path`/crm/objects/2026-03/0-420/${listingID}`, {
      ...options,
  ...
  get(
    listingID: string,
    query: ListingGetParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<ObjectsAPI.SimplePublicObjectWithAssociations> {
    return this._client.get(path`/crm/objects/2026-03/0-420/${listingID}`, { query, ...options });
  }
   ...
   */
  search(
    body: ListingSearchParams,
    options?: RequestOptions,
  ): APIPromise<CrmAPI.CollectionResponseWithTotalSimplePublicObject> {
    return this._client.post('/crm/objects/2026-03/0-420/search', { body, ...options });
  }
}
export class Listings extends BaseListings {
...
export interface ListingListParams extends PageParams {
  /**
...
Listings.Batch = Batch;
Listings.BaseBatch = BaseBatch;
