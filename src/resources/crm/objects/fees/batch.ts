...
export class Batch extends APIResource {
   ...
   *   await client.crm.objects.fees.batch.create({
   *     inputs: [
   *       {
   *         associations: [
   *           {
  ...
  create(
    ...
    return this._client.post('/crm/v3/objects/fees/batch/create', { body, ...options });
  }
   ...
   * ```ts
   * const batchResponseSimplePublicObject =
   *   await client.crm.objects.fees.batch.update({
   *     inputs: [
   *       {
   *         id: 'id',
   *         properties: { foo: 'string' },
  ...
  update(
    ...
    return this._client.post('/crm/v3/objects/fees/batch/update', { body, ...options });
  }
   ...
   * @example
   * ```ts
   * await client.crm.objects.fees.batch.delete({
   *   inputs: [{ id: 'id' }],
   * });
   * ```
   */
  delete(body: BatchDeleteParams, options?: RequestOptions): APIPromise<void> {
    return this._client.post('/crm/v3/objects/fees/batch/archive', {
      body,
      ...options,
   ...
   * ```ts
   * const batchResponseSimplePublicObject =
   *   await client.crm.objects.fees.batch.get({
   *     inputs: [{ id: 'id' }],
   *     properties: ['string'],
  ...
  get(params: BatchGetParams, options?: RequestOptions): APIPromise<CrmAPI.BatchResponseSimplePublicObject> {
    ...
    return this._client.post('/crm/v3/objects/fees/batch/read', { query: { archived }, body, ...options });
  }
   ...
   *   await client.crm.objects.fees.batch.upsert({
   *     inputs: [
   *       {
   *         id: 'id',
   *         properties: { foo: 'string' },
  ...
  upsert(
    ...
    return this._client.post('/crm/v3/objects/fees/batch/upsert', { body, ...options });
  }
}
