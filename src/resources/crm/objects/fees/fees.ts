...
export class Fees extends APIResource {
   ...
   */
  create(
    body: FeeCreateParams,
    options?: RequestOptions,
  ): APIPromise<CrmAPI.CreatedResponseSimplePublicObject> {
    return this._client.post('/crm/v3/objects/fees', { body, ...options });
  }
   ...
   *   await client.crm.objects.fees.update('feeId', {
   *     properties: { foo: 'string' },
   *   });
   * ```
   */
  update(
    ...
    return this._client.patch(path`/crm/v3/objects/fees/${feeID}`, {
      query: { idProperty },
      body,
      ...options,
    });
  ...
  list(
    ...
    return this._client.getAPIList('/crm/v3/objects/fees', Page<CrmAPI.SimplePublicObjectWithAssociations>, {
      query,
      ...options,
    });
  }
  ...
  delete(feeID: string, options?: RequestOptions): APIPromise<void> {
    return this._client.delete(path`/crm/v3/objects/fees/${feeID}`, {
      ...options,
   ...
   *   await client.crm.objects.fees.get('feeId');
   * ```
   */
  get(
    feeID: string,
    ...
    return this._client.get(path`/crm/v3/objects/fees/${feeID}`, { query, ...options });
  }
  ...
  search(
    ...
    return this._client.post('/crm/v3/objects/fees/search', { body, ...options });
  }
}
