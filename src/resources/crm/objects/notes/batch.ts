...
export class Batch extends APIResource {
   ...
   *   await client.crm.objects.notes.batch.create({
  ...
  create(
    ...
    return this._client.post('/crm/v3/objects/notes/batch/create', { body, ...options });
  }
   ...
   * ```ts
   * const batchResponseSimplePublicObject =
   *   await client.crm.objects.notes.batch.update({
  ...
  update(
    ...
    return this._client.post('/crm/v3/objects/notes/batch/update', { body, ...options });
  }
   ...
   *   await client.crm.objects.notes.batch.upsert({
   *     inputs: [{ id: 'id', properties: { foo: 'string' } }],
   *   });
   * ```
   */
  upsert(
    ...
    return this._client.post('/crm/v3/objects/notes/batch/upsert', { body, ...options });
  }
}
