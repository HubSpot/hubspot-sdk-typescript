...
export class Batch extends APIResource {
   ...
   *   await client.crm.objects.carts.batch.create({
   *     inputs: [
   *       {
   *         associations: [
   *           {
  ...
  create(
    ...
    return this._client.post('/crm/v3/objects/carts/batch/create', { body, ...options });
  }
   ...
   * ```ts
   * const batchResponseSimplePublicObject =
   *   await client.crm.objects.carts.batch.update({
   *     inputs: [
   *       {
   *         id: 'id',
   *         properties: { foo: 'string' },
  ...
  update(
    ...
    return this._client.post('/crm/v3/objects/carts/batch/update', { body, ...options });
  }
   ...
   * @example
   * ```ts
   * await client.crm.objects.carts.batch.delete({
   *   inputs: [{ id: 'id' }],
   * });
   * ```
   */
  delete(body: BatchDeleteParams, options?: RequestOptions): APIPromise<void> {
    return this._client.post('/crm/v3/objects/carts/batch/archive', {
      body,
      ...options,
   ...
   * ```ts
   * const batchResponseSimplePublicObject =
   *   await client.crm.objects.carts.batch.get({
   *     inputs: [{ id: 'id' }],
   *     properties: ['string'],
  ...
  get(params: BatchGetParams, options?: RequestOptions): APIPromise<CrmAPI.BatchResponseSimplePublicObject> {
    ...
    return this._client.post('/crm/v3/objects/carts/batch/read', { query: { archived }, body, ...options });
  }
   ...
   *   await client.crm.objects.carts.batch.upsert({
   *     inputs: [
   *       {
   *         id: 'id',
   *         properties: { foo: 'string' },
  ...
  upsert(
    ...
    return this._client.post('/crm/v3/objects/carts/batch/upsert', { body, ...options });
  }
}
