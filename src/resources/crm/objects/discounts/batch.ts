...
export class Batch extends APIResource {
   ...
   *   await client.crm.objects.discounts.batch.create({
  ...
  create(
    ...
    return this._client.post('/crm/v3/objects/discounts/batch/create', { body, ...options });
  }
   ...
   * ```ts
   * const batchResponseSimplePublicObject =
   *   await client.crm.objects.discounts.batch.update({
  ...
  update(
    ...
    return this._client.post('/crm/v3/objects/discounts/batch/update', { body, ...options });
  }
   ...
   * @example
   * ```ts
   * await client.crm.objects.discounts.batch.delete({
   *   inputs: [{ id: 'id' }],
   * });
   * ```
   */
  delete(body: BatchDeleteParams, options?: RequestOptions): APIPromise<void> {
    return this._client.post('/crm/v3/objects/discounts/batch/archive', {
      body,
      ...options,
   ...
   * ```ts
   * const batchResponseSimplePublicObject =
   *   await client.crm.objects.discounts.batch.get({
   *     inputs: [{ id: 'id' }],
   *     properties: ['string'],
  ...
  get(params: BatchGetParams, options?: RequestOptions): APIPromise<CrmAPI.BatchResponseSimplePublicObject> {
    ...
    return this._client.post('/crm/v3/objects/discounts/batch/read', {
      query: { archived },
      body,
      ...options,
    });
   ...
   *   await client.crm.objects.discounts.batch.upsert({
   *     inputs: [{ id: 'id', properties: { foo: 'string' } }],
   *   });
   * ```
   */
  upsert(
    ...
    return this._client.post('/crm/v3/objects/discounts/batch/upsert', { body, ...options });
  }
}
