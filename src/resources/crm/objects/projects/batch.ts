...
export class BaseBatch extends APIResource {
  static override readonly _key: readonly ['crm', 'objects', 'projects', 'batch'] = Object.freeze([
    'crm',
    'objects',
    'projects',
    'batch',
  ...
  create(
    ...
    return this._client.post('/crm/objects/2026-03/projects/batch/create', { body, ...options });
  }
  ...
  update(
    ...
    return this._client.post('/crm/objects/2026-03/projects/batch/update', { body, ...options });
  }
  ...
  delete(body: BatchDeleteParams, options?: RequestOptions): APIPromise<void> {
    return this._client.post('/crm/objects/2026-03/projects/batch/archive', {
      body,
      ...options,
  ...
  get(
    ...
    return this._client.post('/crm/objects/2026-03/projects/batch/read', {
      query: { archived },
      body,
      ...options,
    });
  ...
  upsert(
    ...
    return this._client.post('/crm/objects/2026-03/projects/batch/upsert', { body, ...options });
  }
}
