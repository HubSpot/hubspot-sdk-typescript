...
export class BaseTaxes extends APIResource {
   ...
   * provided.
   */
  create(body: TaxCreateParams, options?: RequestOptions): APIPromise<CrmAPI.SimplePublicObject> {
    return this._client.post('/crm/objects/2026-03/taxes', { body, ...options });
  }
  ...
  update(
    ...
    return this._client.patch(path`/crm/objects/2026-03/taxes/${taxID}`, {
      query: { idProperty },
      body,
      ...options,
    });
  ...
  delete(taxID: string, options?: RequestOptions): APIPromise<void> {
    return this._client.delete(path`/crm/objects/2026-03/taxes/${taxID}`, {
      ...options,
  ...
  get(
    ...
    return this._client.get(path`/crm/objects/2026-03/taxes/${taxID}`, { query, ...options });
  }
