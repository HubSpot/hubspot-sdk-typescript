...
export class BaseEmails extends APIResource {
  static override readonly _key: readonly ['crm', 'objects', 'emails'] = Object.freeze([
    'crm',
    'objects',
    'emails',
  ] as const);
   ...
   * provided.
   */
  create(body: EmailCreateParams, options?: RequestOptions): APIPromise<CrmAPI.SimplePublicObject> {
    return this._client.post('/crm/objects/2026-03/emails', { body, ...options });
  }
  ...
  update(
    ...
    return this._client.patch(path`/crm/objects/2026-03/emails/${emailID}`, {
      query: { idProperty },
      body,
      ...options,
    });
  ...
  delete(emailID: string, options?: RequestOptions): APIPromise<void> {
    return this._client.delete(path`/crm/objects/2026-03/emails/${emailID}`, {
      ...options,
  ...
  get(
    ...
    return this._client.get(path`/crm/objects/2026-03/emails/${emailID}`, { query, ...options });
  }
