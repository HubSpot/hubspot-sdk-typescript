...
export class Batch extends APIResource {
   ...
   *   await client.crm.objects.emails.batch.create({
  ...
  create(
    ...
    return this._client.post('/crm/v3/objects/emails/batch/create', { body, ...options });
  }
   ...
   * ```ts
   * const batchResponseSimplePublicObject =
   *   await client.crm.objects.emails.batch.update({
  ...
  update(
    ...
    return this._client.post('/crm/v3/objects/emails/batch/update', { body, ...options });
  }
   ...
   * @example
   * ```ts
   * await client.crm.objects.emails.batch.delete({
   *   inputs: [{ id: 'id' }],
   * });
   * ```
   */
  delete(body: BatchDeleteParams, options?: RequestOptions): APIPromise<void> {
    return this._client.post('/crm/v3/objects/emails/batch/archive', {
      body,
      ...options,
   ...
   * ```ts
   * const batchResponseSimplePublicObject =
   *   await client.crm.objects.emails.batch.read({
   *     inputs: [{ id: 'id' }],
   *     properties: ['string'],
  ...
  read(
    ...
    return this._client.post('/crm/v3/objects/emails/batch/read', { query: { archived }, body, ...options });
  }
   ...
   *   await client.crm.objects.emails.batch.upsert({
   *     inputs: [{ id: 'id', properties: { foo: 'string' } }],
   *   });
   * ```
   */
  upsert(
    ...
    return this._client.post('/crm/v3/objects/emails/batch/upsert', { body, ...options });
  }
}
