...
export class BaseServices extends APIResource {
  static override readonly _key: readonly ['crm', 'objects', 'services'] = Object.freeze([
    'crm',
    'objects',
    'services',
  ] as const);
   ...
   * provided.
   */
  create(body: ServiceCreateParams, options?: RequestOptions): APIPromise<CrmAPI.SimplePublicObject> {
    return this._client.post('/crm/objects/2026-03/0-162', { body, ...options });
  }
  ...
  update(
    ...
    return this._client.patch(path`/crm/objects/2026-03/0-162/${serviceID}`, {
      query: { idProperty },
      body,
      ...options,
    });
  ...
  delete(serviceID: string, options?: RequestOptions): APIPromise<void> {
    return this._client.delete(path`/crm/objects/2026-03/0-162/${serviceID}`, {
      ...options,
  ...
  get(
    ...
    return this._client.get(path`/crm/objects/2026-03/0-162/${serviceID}`, { query, ...options });
  }
