...
export class Batch extends APIResource {
   ...
   *   await client.crm.objects.objects.batch.create(
   *     'objectType',
   *     {
   *       inputs: [
   *         {
   ...
   * ```ts
   * const batchResponseSimplePublicObject =
   *   await client.crm.objects.objects.batch.update(
   *     'objectType',
   *     {
   *       inputs: [
   *         {
   ...
   * @example
   * ```ts
   * await client.crm.objects.objects.batch.delete(
   *   'objectType',
   *   { inputs: [{ id: 'id' }] },
   * );
   * ```
   ...
   * ```ts
   * const batchResponseSimplePublicObject =
   *   await client.crm.objects.objects.batch.get('objectType', {
   *     inputs: [{ id: 'id' }],
   *     properties: ['string'],
   ...
   *   await client.crm.objects.objects.batch.upsert(
   *     'objectType',
   *     {
   *       inputs: [
   *         {
