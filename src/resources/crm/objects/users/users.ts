...
export class BaseUsers extends APIResource {
  static override readonly _key: readonly ['crm', 'objects', 'users'] = Object.freeze([
    'crm',
    'objects',
    'users',
  ] as const);
   ...
   * provided.
   */
  create(body: UserCreateParams, options?: RequestOptions): APIPromise<CrmAPI.SimplePublicObject> {
    return this._client.post('/crm/objects/2026-03/users', { body, ...options });
  }
  ...
  update(
    ...
    return this._client.patch(path`/crm/objects/2026-03/users/${userID}`, {
      query: { idProperty },
      body,
      ...options,
    });
  ...
  delete(userID: string, options?: RequestOptions): APIPromise<void> {
    return this._client.delete(path`/crm/objects/2026-03/users/${userID}`, {
      ...options,
  ...
  get(
    ...
    return this._client.get(path`/crm/objects/2026-03/users/${userID}`, { query, ...options });
  }
