...
export class Batch extends APIResource {
   ...
   *   await client.crm.objects.contracts.batch.create({
  ...
  create(
    ...
    return this._client.post('/crm/v3/objects/contracts/batch/create', { body, ...options });
  }
   ...
   * ```ts
   * const batchResponseSimplePublicObject =
   *   await client.crm.objects.contracts.batch.update({
  ...
  update(
    ...
    return this._client.post('/crm/v3/objects/contracts/batch/update', { body, ...options });
  }
   ...
   * @example
   * ```ts
   * await client.crm.objects.contracts.batch.delete({
   *   inputs: [{ id: 'id' }],
   * });
   * ```
   */
  delete(body: BatchDeleteParams, options?: RequestOptions): APIPromise<void> {
    return this._client.post('/crm/v3/objects/contracts/batch/archive', {
      body,
      ...options,
   ...
   * ```ts
   * const batchResponseSimplePublicObject =
   *   await client.crm.objects.contracts.batch.get({
   *     inputs: [{ id: 'id' }],
   *     properties: ['string'],
  ...
  get(params: BatchGetParams, options?: RequestOptions): APIPromise<CRMAPI.BatchResponseSimplePublicObject> {
    ...
    return this._client.post('/crm/v3/objects/contracts/batch/read', {
      query: { archived },
      body,
      ...options,
    });
   ...
   *   await client.crm.objects.contracts.batch.upsert({
   *     inputs: [{ id: 'id', properties: { foo: 'string' } }],
   *   });
   * ```
   */
  upsert(
    ...
    return this._client.post('/crm/v3/objects/contracts/batch/upsert', { body, ...options });
  }
}
