...
export class BaseCalls extends APIResource {
  static override readonly _key: readonly ['crm', 'objects', 'calls'] = Object.freeze([
    'crm',
    'objects',
    'calls',
  ] as const);
   ...
   * provided.
   */
  create(body: CallCreateParams, options?: RequestOptions): APIPromise<CrmAPI.SimplePublicObject> {
    return this._client.post('/crm/objects/2026-03/calls', { body, ...options });
  }
  ...
  update(
    ...
    return this._client.patch(path`/crm/objects/2026-03/calls/${callID}`, {
      query: { idProperty },
      body,
      ...options,
    });
  ...
  delete(callID: string, options?: RequestOptions): APIPromise<void> {
    return this._client.delete(path`/crm/objects/2026-03/calls/${callID}`, {
      ...options,
  ...
  get(
    ...
    return this._client.get(path`/crm/objects/2026-03/calls/${callID}`, { query, ...options });
  }
  ...
  search(
    ...
    return this._client.post('/crm/objects/2026-03/calls/search', { body, ...options });
  }
}
