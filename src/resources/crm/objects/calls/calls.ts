...
export class Calls extends APIResource {
   ...
   *   await client.crm.objects.calls.create({
  ...
  create(
    ...
    return this._client.post('/crm/v3/objects/calls', { body, ...options });
  }
   ...
   *   await client.crm.objects.calls.update('callId', {
   *     properties: {
  ...
  update(
    ...
    return this._client.patch(path`/crm/v3/objects/calls/${callID}`, {
      query: { idProperty },
      body,
      ...options,
    });
  ...
  list(
    ...
    return this._client.getAPIList('/crm/v3/objects/calls', Page<CrmAPI.SimplePublicObjectWithAssociations>, {
      query,
      ...options,
    });
  }
  ...
  delete(callID: string, options?: RequestOptions): APIPromise<void> {
    return this._client.delete(path`/crm/v3/objects/calls/${callID}`, {
      ...options,
   ...
   *   await client.crm.objects.calls.get('callId');
   * ```
   */
  get(
    callID: string,
    query: CallGetParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<CrmAPI.SimplePublicObjectWithAssociations> {
    return this._client.get(path`/crm/v3/objects/calls/${callID}`, { query, ...options });
  }
   ...
   *   await client.crm.objects.calls.search();
   * ```
   */
  search(
    body: CallSearchParams,
    options?: RequestOptions,
  ): APIPromise<CrmAPI.CollectionResponseWithTotalSimplePublicObject> {
    return this._client.post('/crm/v3/objects/calls/search', { body, ...options });
  }
}
...
export interface CallListParams extends PageParams {
  /**
