...
export class BaseBatch extends APIResource {
  static override readonly _key: readonly ['crm', 'objects', 'calls', 'batch'] = Object.freeze([
    'crm',
    'objects',
    'calls',
    'batch',
  ...
  create(
    ...
    return this._client.post('/crm/objects/2026-03/calls/batch/create', { body, ...options });
  }
  ...
  update(
    ...
    return this._client.post('/crm/objects/2026-03/calls/batch/update', { body, ...options });
  }
  ...
  delete(body: BatchDeleteParams, options?: RequestOptions): APIPromise<void> {
    return this._client.post('/crm/objects/2026-03/calls/batch/archive', {
      body,
      ...options,
  ...
  get(
    ...
    return this._client.post('/crm/objects/2026-03/calls/batch/read', {
      query: { archived },
      body,
      ...options,
    });
  ...
  upsert(
    ...
    return this._client.post('/crm/objects/2026-03/calls/batch/upsert', { body, ...options });
  }
}
