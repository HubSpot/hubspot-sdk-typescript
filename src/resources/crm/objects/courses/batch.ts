...
export class BaseBatch extends APIResource {
  static override readonly _key: readonly ['crm', 'objects', 'courses', 'batch'] = Object.freeze([
    'crm',
    'objects',
    'courses',
    'batch',
  ...
  create(
    ...
    return this._client.post('/crm/objects/2026-03/0-410/batch/create', { body, ...options });
  }
  ...
  update(
    ...
    return this._client.post('/crm/objects/2026-03/0-410/batch/update', { body, ...options });
  }
  ...
  delete(body: BatchDeleteParams, options?: RequestOptions): APIPromise<void> {
    return this._client.post('/crm/objects/2026-03/0-410/batch/archive', {
      body,
      ...options,
  ...
  get(
    ...
    return this._client.post('/crm/objects/2026-03/0-410/batch/read', {
      query: { archived },
      body,
      ...options,
    });
  ...
  upsert(
    ...
    return this._client.post('/crm/objects/2026-03/0-410/batch/upsert', { body, ...options });
  }
}
