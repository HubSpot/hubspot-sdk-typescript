...
export class Batch extends APIResource {
   ...
   *   await client.crm.objects.courses.batch.create({
   *     inputs: [
   *       {
   *         associations: [
   *           {
  ...
  create(
    ...
    return this._client.post('/crm/v3/objects/0-410/batch/create', { body, ...options });
  }
   ...
   * ```ts
   * const batchResponseSimplePublicObject =
   *   await client.crm.objects.courses.batch.update({
  ...
  update(
    ...
    return this._client.post('/crm/v3/objects/0-410/batch/update', { body, ...options });
  }
   ...
   * @example
   * ```ts
   * await client.crm.objects.courses.batch.delete({
   *   inputs: [{ id: 'id' }],
   * });
   * ```
   */
  delete(body: BatchDeleteParams, options?: RequestOptions): APIPromise<void> {
    return this._client.post('/crm/v3/objects/0-410/batch/archive', {
      body,
      ...options,
   ...
   * ```ts
   * const batchResponseSimplePublicObject =
   *   await client.crm.objects.courses.batch.get({
   *     inputs: [{ id: 'id' }],
   *     properties: ['string'],
  ...
  get(params: BatchGetParams, options?: RequestOptions): APIPromise<CrmAPI.BatchResponseSimplePublicObject> {
    ...
    return this._client.post('/crm/v3/objects/0-410/batch/read', { query: { archived }, body, ...options });
  }
   ...
   *   await client.crm.objects.courses.batch.upsert({
   *     inputs: [{ id: 'id', properties: { foo: 'string' } }],
   *   });
   * ```
   */
  upsert(
    ...
    return this._client.post('/crm/v3/objects/0-410/batch/upsert', { body, ...options });
  }
}
