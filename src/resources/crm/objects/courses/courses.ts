...
export class Courses extends APIResource {
   ...
   */
  create(
    body: CourseCreateParams,
    options?: RequestOptions,
  ): APIPromise<CrmAPI.CreatedResponseSimplePublicObject> {
    return this._client.post('/crm/v3/objects/0-410', { body, ...options });
  }
   ...
   *   await client.crm.objects.courses.update('courseId', {
   *     properties: {
  ...
  update(
    ...
    return this._client.patch(path`/crm/v3/objects/0-410/${courseID}`, {
      query: { idProperty },
      body,
      ...options,
    });
  ...
  list(
    ...
    return this._client.getAPIList('/crm/v3/objects/0-410', Page<CrmAPI.SimplePublicObjectWithAssociations>, {
      query,
      ...options,
    });
  }
  ...
  delete(courseID: string, options?: RequestOptions): APIPromise<void> {
    return this._client.delete(path`/crm/v3/objects/0-410/${courseID}`, {
      ...options,
   ...
   *   await client.crm.objects.courses.get('courseId');
   * ```
   */
  get(
    courseID: string,
    ...
    return this._client.get(path`/crm/v3/objects/0-410/${courseID}`, { query, ...options });
  }
  ...
  search(
    ...
    return this._client.post('/crm/v3/objects/0-410/search', { body, ...options });
  }
}
