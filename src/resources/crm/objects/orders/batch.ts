...
export class Batch extends APIResource {
  ...
  create(
    ...
    return this._client.post('/crm/v3/objects/orders/batch/create', { body, ...options });
  }
   ...
   * ```ts
   * const batchResponseSimplePublicObject =
   *   await client.crm.objects.orders.batch.update({
  ...
  update(
    ...
    return this._client.post('/crm/v3/objects/orders/batch/update', { body, ...options });
  }
   ...
   * @example
   * ```ts
   * await client.crm.objects.orders.batch.delete({
   *   inputs: [{ id: 'id' }],
   * });
   * ```
   */
  delete(body: BatchDeleteParams, options?: RequestOptions): APIPromise<void> {
    return this._client.post('/crm/v3/objects/orders/batch/archive', {
      body,
      ...options,
   ...
   * ```ts
   * const batchResponseSimplePublicObject =
   *   await client.crm.objects.orders.batch.get({
   *     inputs: [{ id: 'id' }],
   *     properties: ['string'],
  ...
  get(params: BatchGetParams, options?: RequestOptions): APIPromise<CRMAPI.BatchResponseSimplePublicObject> {
    ...
    return this._client.post('/crm/v3/objects/orders/batch/read', { query: { archived }, body, ...options });
  }
   ...
   *   await client.crm.objects.orders.batch.upsert({
   *     inputs: [{ id: 'id', properties: { foo: 'string' } }],
   *   });
   * ```
   */
  upsert(
    ...
    return this._client.post('/crm/v3/objects/orders/batch/upsert', { body, ...options });
  }
}
