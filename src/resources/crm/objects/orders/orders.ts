...
export class BaseOrders extends APIResource {
  static override readonly _key: readonly ['crm', 'objects', 'orders'] = Object.freeze([
    'crm',
    'objects',
    'orders',
  ] as const);
   ...
   * provided.
   */
  create(body: OrderCreateParams, options?: RequestOptions): APIPromise<CrmAPI.SimplePublicObject> {
    return this._client.post('/crm/objects/2026-03/orders', { body, ...options });
  }
  ...
  update(
    ...
    return this._client.patch(path`/crm/objects/2026-03/orders/${orderID}`, {
      query: { idProperty },
      body,
      ...options,
    });
  ...
  delete(orderID: string, options?: RequestOptions): APIPromise<void> {
    return this._client.delete(path`/crm/objects/2026-03/orders/${orderID}`, {
      ...options,
  ...
  get(
    ...
    return this._client.get(path`/crm/objects/2026-03/orders/${orderID}`, { query, ...options });
  }
