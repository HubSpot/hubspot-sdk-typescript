...
export class Invoices extends APIResource {
   ...
   *   await client.crm.objects.invoices.create({
  ...
  create(
    ...
    return this._client.post('/crm/v3/objects/invoices', { body, ...options });
  }
  ...
  update(
    ...
    return this._client.patch(path`/crm/v3/objects/invoices/${invoiceID}`, {
      query: { idProperty },
      body,
      ...options,
    });
   ...
   * ```
   */
  delete(invoiceID: string, options?: RequestOptions): APIPromise<void> {
    return this._client.delete(path`/crm/v3/objects/invoices/${invoiceID}`, {
      ...options,
   ...
   *   await client.crm.objects.invoices.get('invoiceId');
   * ```
   */
  get(
    invoiceID: string,
    query: InvoiceGetParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<CRMAPI.SimplePublicObjectWithAssociations> {
    return this._client.get(path`/crm/v3/objects/invoices/${invoiceID}`, { query, ...options });
  }
   ...
   *   await client.crm.objects.invoices.search();
   * ```
   */
  search(
    ...
    return this._client.post('/crm/v3/objects/invoices/search', { body, ...options });
  }
}
