...
export class Invoices extends APIResource {
   ...
   * provided.
   */
  create(body: InvoiceCreateParams, options?: RequestOptions): APIPromise<CrmAPI.SimplePublicObject> {
    return this._client.post('/crm/objects/2026-03/invoices', { body, ...options });
  }
  ...
  update(
    ...
    return this._client.patch(path`/crm/objects/2026-03/invoices/${invoiceID}`, {
      query: { idProperty },
      body,
      ...options,
    });
  ...
  delete(invoiceID: string, options?: RequestOptions): APIPromise<void> {
    return this._client.delete(path`/crm/objects/2026-03/invoices/${invoiceID}`, {
      ...options,
  ...
  get(
    ...
    return this._client.get(path`/crm/objects/2026-03/invoices/${invoiceID}`, { query, ...options });
  }
