...
export class Batch extends APIResource {
   ...
   *   await client.crm.objects.commercePayments.batch.create({
  ...
  create(
    ...
    return this._client.post('/crm/v3/objects/commerce_payments/batch/create', { body, ...options });
  }
   ...
   * ```ts
   * const batchResponseSimplePublicObject =
   *   await client.crm.objects.commercePayments.batch.update({
  ...
  update(
    ...
    return this._client.post('/crm/v3/objects/commerce_payments/batch/update', { body, ...options });
  }
   ...
   * @example
   * ```ts
   * await client.crm.objects.commercePayments.batch.delete({
   *   inputs: [{ id: 'id' }],
   * });
   * ```
   */
  delete(body: BatchDeleteParams, options?: RequestOptions): APIPromise<void> {
    return this._client.post('/crm/v3/objects/commerce_payments/batch/archive', {
      body,
      ...options,
   ...
   * ```ts
   * const batchResponseSimplePublicObject =
   *   await client.crm.objects.commercePayments.batch.get({
   *     inputs: [{ id: 'id' }],
   *     properties: ['string'],
  ...
  get(params: BatchGetParams, options?: RequestOptions): APIPromise<CRMAPI.BatchResponseSimplePublicObject> {
    ...
    return this._client.post('/crm/v3/objects/commerce_payments/batch/read', {
      query: { archived },
      body,
      ...options,
    });
  ...
  upsert(
    ...
    return this._client.post('/crm/v3/objects/commerce_payments/batch/upsert', { body, ...options });
  }
}
