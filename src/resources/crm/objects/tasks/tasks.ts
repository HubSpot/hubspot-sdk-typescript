...
export class BaseTasks extends APIResource {
  static override readonly _key: readonly ['crm', 'objects', 'tasks'] = Object.freeze([
    'crm',
    'objects',
    'tasks',
  ] as const);
   ...
   * provided.
   */
  create(body: TaskCreateParams, options?: RequestOptions): APIPromise<CrmAPI.SimplePublicObject> {
    return this._client.post('/crm/objects/2026-03/tasks', { body, ...options });
  }
  ...
  update(
    ...
    return this._client.patch(path`/crm/objects/2026-03/tasks/${taskID}`, {
      query: { idProperty },
      body,
      ...options,
    });
  ...
  delete(taskID: string, options?: RequestOptions): APIPromise<void> {
    return this._client.delete(path`/crm/objects/2026-03/tasks/${taskID}`, {
      ...options,
  ...
  get(
    ...
    return this._client.get(path`/crm/objects/2026-03/tasks/${taskID}`, { query, ...options });
  }
