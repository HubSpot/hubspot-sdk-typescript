...
export class Listings extends APIResource {
  ...
  create(
    ...
    return this._client.post('/crm/objects/2026-03/0-420/batch/create', { body, ...options });
  }
  ...
  update(
    ...
    return this._client.post('/crm/objects/2026-03/0-420/batch/update', { body, ...options });
  }
   ...
   */
  delete(body: ListingDeleteParams, options?: RequestOptions): APIPromise<void> {
    return this._client.post('/crm/objects/2026-03/0-420/batch/archive', {
      body,
      ...options,
  ...
  get(
    ...
    return this._client.post('/crm/objects/2026-03/0-420/batch/read', {
      query: { archived },
      body,
      ...options,
    });
   ...
   */
  upsert(
    body: ListingUpsertParams,
    options?: RequestOptions,
  ): APIPromise<ObjectsAPI.BatchResponseSimplePublicUpsertObject> {
    return this._client.post('/crm/objects/2026-03/0-420/batch/upsert', { body, ...options });
  }
}
...
export interface ListingUpsertParams {
