...
export class Batch extends APIResource {
  ...
  create(
    ...
    return this._client.post('/crm/objects/2026-03/communications/batch/create', { body, ...options });
  }
  ...
  update(
    ...
    return this._client.post('/crm/objects/2026-03/communications/batch/update', { body, ...options });
  }
  ...
  delete(body: BatchDeleteParams, options?: RequestOptions): APIPromise<void> {
    return this._client.post('/crm/objects/2026-03/communications/batch/archive', {
      body,
      ...options,
  ...
  get(
    ...
    return this._client.post('/crm/objects/2026-03/communications/batch/read', {
      query: { archived },
      body,
      ...options,
    });
