...
export class Meetings extends APIResource {
   ...
   * provided.
   */
  create(body: MeetingCreateParams, options?: RequestOptions): APIPromise<CrmAPI.SimplePublicObject> {
    return this._client.post('/crm/objects/2026-03/meetings', { body, ...options });
  }
  ...
  update(
    ...
    return this._client.patch(path`/crm/objects/2026-03/meetings/${meetingID}`, {
      query: { idProperty },
      body,
      ...options,
    });
  ...
  get(
    ...
    return this._client.get(path`/crm/objects/2026-03/meetings/${meetingID}`, { query, ...options });
  }
