...
export class BaseBatch extends APIResource {
  static override readonly _key: readonly ['crm', 'objects', 'contacts', 'batch'] = Object.freeze([
    'crm',
    'objects',
    'contacts',
    'batch',
  ...
  create(
    ...
    return this._client.post('/crm/objects/2026-03/contacts/batch/create', { body, ...options });
  }
  ...
  update(
    ...
    return this._client.post('/crm/objects/2026-03/contacts/batch/update', { body, ...options });
  }
  ...
  delete(body: BatchDeleteParams, options?: RequestOptions): APIPromise<void> {
    return this._client.post('/crm/objects/2026-03/contacts/batch/archive', {
      body,
      ...options,
  ...
  get(
    ...
    return this._client.post('/crm/objects/2026-03/contacts/batch/read', {
      query: { archived },
      body,
      ...options,
    });
  ...
  upsert(
    ...
    return this._client.post('/crm/objects/2026-03/contacts/batch/upsert', { body, ...options });
  }
}
