...
export class BaseBatch extends APIResource {
  static override readonly _key: readonly ['crm', 'objects', 'companies', 'batch'] = Object.freeze([
    'crm',
    'objects',
    'companies',
    'batch',
  ...
  create(
    ...
    return this._client.post('/crm/objects/2026-03/companies/batch/create', { body, ...options });
  }
  ...
  update(
    ...
    return this._client.post('/crm/objects/2026-03/companies/batch/update', { body, ...options });
  }
  ...
  delete(body: BatchDeleteParams, options?: RequestOptions): APIPromise<void> {
    return this._client.post('/crm/objects/2026-03/companies/batch/archive', {
      body,
      ...options,
  ...
  get(
    ...
    return this._client.post('/crm/objects/2026-03/companies/batch/read', {
      query: { archived },
      body,
      ...options,
    });
  ...
  upsert(
    ...
    return this._client.post('/crm/objects/2026-03/companies/batch/upsert', { body, ...options });
  }
}
