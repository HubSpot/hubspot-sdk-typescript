...
export class GenericObjects extends APIResource {
  ...
  create(
    objectType: string,
    body: GenericObjectCreateParams,
  ...
  list(
    objectType: string,
    query: GenericObjectListParams | null | undefined = {},
    options?: RequestOptions,
   ...
   */
  delete(objectID: string, params: GenericObjectDeleteParams, options?: RequestOptions): APIPromise<void> {
  ...
  search(
    objectType: string,
    body: GenericObjectSearchParams,
    options?: RequestOptions,
...
export interface GenericObjectUpdateParams {
  /**
   * Path param
   */
  objectType: string;
...
export interface GenericObjectListParams extends PageParams {
  /**
...
export interface GenericObjectDeleteParams {
  objectType: string;
}

export interface GenericObjectGetParams {
  /**
   * Path param
   */
  objectType: string;
...
export interface GenericObjectSearchParams {
  /**
