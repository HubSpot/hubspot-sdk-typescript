...
export class Batch extends APIResource {
   ...
   *   await client.crm.users.batch.create({
   *     inputs: [
   *       {
   *         associations: [
   *           {
  ...
  create(
    ...
    return this._client.post('/crm/v3/objects/users/batch/create', { body, ...options });
  }
   ...
   * ```ts
   * const batchResponseSimplePublicObject =
   *   await client.crm.users.batch.update({
   *     inputs: [
   *       {
   *         id: 'id',
   *         properties: { foo: 'string' },
  ...
  update(
    ...
    return this._client.post('/crm/v3/objects/users/batch/update', { body, ...options });
  }
   ...
   * @example
   * ```ts
   * await client.crm.users.batch.delete({
   *   inputs: [{ id: 'id' }],
   * });
   * ```
   */
  delete(body: BatchDeleteParams, options?: RequestOptions): APIPromise<void> {
    return this._client.post('/crm/v3/objects/users/batch/archive', {
      body,
      ...options,
   ...
   * ```ts
   * const batchResponseSimplePublicObject =
   *   await client.crm.users.batch.get({
   *     inputs: [{ id: 'id' }],
   *     properties: ['string'],
  ...
  get(params: BatchGetParams, options?: RequestOptions): APIPromise<CrmAPI.BatchResponseSimplePublicObject> {
    ...
    return this._client.post('/crm/v3/objects/users/batch/read', { query: { archived }, body, ...options });
  }
   ...
   *   await client.crm.users.batch.upsert({
   *     inputs: [
   *       {
   *         id: 'id',
   *         properties: { foo: 'string' },
  ...
  upsert(
    ...
    return this._client.post('/crm/v3/objects/users/batch/upsert', { body, ...options });
  }
}
