...
import * as AbTestAPI from './ab-test';
import {
  AbTest,
...
import { BaseDraft, Draft, DraftUpdateDraftParams } from './draft';
...
export class BaseSitePages extends APIResource {
  static override readonly _key: readonly ['cms', 'pages', 'sitePages'] = Object.freeze([
    'cms',
    'pages',
    'sitePages',
  ] as const);
   ...
   */
  create(body: SitePageCreateParams, options?: RequestOptions): APIPromise<PagesAPI.PagesPage> {
  ...
  list(
    ...
    return this._client.getAPIList('/cms/pages/2026-03/site-pages', Page<PagesAPI.PagesPage>, {
      query,
      ...options,
    });
  }
  ...
  delete(
    ...
    return this._client.delete(path`/cms/pages/2026-03/site-pages/${objectID}`, {
      query: { archived },
      ...options,
   ...
   */
  clone(body: SitePageCloneParams, options?: RequestOptions): APIPromise<PagesAPI.PagesPage> {
  ...
  schedule(body: SitePageScheduleParams, options?: RequestOptions): APIPromise<void> {
    return this._client.post('/cms/pages/2026-03/site-pages/schedule', {
      body,
      ...options,
...
export class SitePages extends BaseSitePages {
  abTest: AbTestAPI.AbTest = new AbTestAPI.AbTest(this._client);
...
SitePages.AbTest = AbTest;
SitePages.BaseAbTest = BaseAbTest;
SitePages.Batch = Batch;
SitePages.BaseBatch = BaseBatch;
SitePages.Draft = Draft;
SitePages.BaseDraft = BaseDraft;
SitePages.MultiLanguage = MultiLanguage;
SitePages.BaseMultiLanguage = BaseMultiLanguage;
SitePages.Revisions = Revisions;
SitePages.BaseRevisions = BaseRevisions;
...
export declare namespace SitePages {
  ...
  export { Draft as Draft, BaseDraft as BaseDraft, type DraftUpdateDraftParams as DraftUpdateDraftParams };
