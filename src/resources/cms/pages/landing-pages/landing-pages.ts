...
import { BaseDraft, Draft, DraftUpdateParams } from './draft';
...
export class BaseLandingPages extends APIResource {
  ...
  delete(
    ...
    return this._client.delete(path`/cms/pages/2026-03/landing-pages/${objectID}`, {
      query: { archived },
      ...options,
  ...
  schedule(body: LandingPageScheduleParams, options?: RequestOptions): APIPromise<void> {
    return this._client.post('/cms/pages/2026-03/landing-pages/schedule', {
      body,
      ...options,
...
LandingPages.AbTest = AbTest;
LandingPages.BaseAbTest = BaseAbTest;
LandingPages.Batch = Batch;
LandingPages.BaseBatch = BaseBatch;
LandingPages.Draft = Draft;
LandingPages.BaseDraft = BaseDraft;
LandingPages.Folders = Folders;
LandingPages.BaseFolders = BaseFolders;
LandingPages.MultiLanguage = MultiLanguage;
LandingPages.BaseMultiLanguage = BaseMultiLanguage;
LandingPages.Revisions = Revisions;
LandingPages.BaseRevisions = BaseRevisions;
...
export declare namespace LandingPages {
  ...
  export { Draft as Draft, BaseDraft as BaseDraft, type DraftUpdateParams as DraftUpdateParams };
