...
export class BaseDraft extends APIResource {
  static override readonly _key: readonly ['cms', 'pages', 'landingPages', 'draft'] = Object.freeze([
    'cms',
    'pages',
    'landingPages',
    'draft',
   ...
   */
  get(objectID: string, options?: RequestOptions): APIPromise<PagesAPI.PagesPage> {
   ...
   */
  reset(objectID: string, options?: RequestOptions): APIPromise<void> {
...
export declare namespace Draft {
  export { type DraftUpdateParams as DraftUpdateParams };
}
