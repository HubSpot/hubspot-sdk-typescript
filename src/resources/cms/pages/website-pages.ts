...
export class BaseWebsitePages extends APIResource {
   ...
   */
  create(body: WebsitePageCreateParams, options?: RequestOptions): APIPromise<PagesAPI.PagesPage> {
  ...
  delete(
    objectID: string,
    params: WebsitePageDeleteParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<void> {
   ...
   */
  clone(body: WebsitePageCloneParams, options?: RequestOptions): APIPromise<PagesAPI.PagesPage> {
   ...
   */
  schedule(body: WebsitePageScheduleParams, options?: RequestOptions): APIPromise<void> {
   ...
   */
  setNewLangPrimary(body: WebsitePageSetNewLangPrimaryParams, options?: RequestOptions): APIPromise<void> {
...
export interface WebsitePageListParams extends PageParams {
  /**
...
export interface WebsitePageCloneParams {
  /**
...
export interface WebsitePageGetParams {
  /**
   * Whether to return only results that have been archived.
   */
  archived?: boolean;
...
export interface WebsitePageScheduleParams {
  /**
...
export interface WebsitePageSetNewLangPrimaryParams {
  /**
...
export interface WebsitePageUpdateDraftParams {
  /**
   * The unique ID of the page.
   */
  id: string;
...
export declare namespace WebsitePages {
  export {
