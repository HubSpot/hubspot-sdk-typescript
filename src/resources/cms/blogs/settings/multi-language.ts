...
export class MultiLanguage extends APIResource {
  attachToLangGroup(
    ...
    return this._client.post('/cms/blog-settings/2026-03/settings/multi-language/attach-to-lang-group', {
      body,
      ...options,
  ...
  createLanguageVariation(
    ...
    options?: RequestOptions,
  ): APIPromise<SettingsAPI.Blog> {
    return this._client.post('/cms/blog-settings/2026-03/settings/multi-language/create-language-variation', {
      body,
      ...options,
    });
  }
  ...
  detachFromLangGroup(
    ...
    return this._client.post('/cms/blog-settings/2026-03/settings/multi-language/detach-from-lang-group', {
      body,
      ...options,
      headers: buildHeaders([{ Accept: '*/*' }, options?.headers]),
      __binaryResponse: true,
...
export interface MultiLanguageSetNewLangPrimaryParams {
  /**
