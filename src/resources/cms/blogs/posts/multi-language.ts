...
export class BaseMultiLanguage extends APIResource {
   ...
   */
  createLangVariation(
    body: MultiLanguageCreateLangVariationParams,
    options?: RequestOptions,
  ): APIPromise<Response> {
   ...
   */
  setLangPrimary(body: MultiLanguageSetLangPrimaryParams, options?: RequestOptions): APIPromise<void> {
   ...
   * [multi-language group](https://developers.hubspot.com/docs/guides/cms/content/multi-language-content).
   */
  updateLangs(body: MultiLanguageUpdateLangsParams, options?: RequestOptions): APIPromise<Response> {
...
export interface MultiLanguageCreateLangVariationParams {
  /**
...
export interface MultiLanguageSetLangPrimaryParams {
  /**
...
export interface MultiLanguageUpdateLangsParams {
  /**
