...
export class SiteSearch extends APIResource {
   ...
   * @example
   * ```ts
   * const response = await client.cms.siteSearch.getIndexedData(
   *   'contentId',
   * );
   * ```
   */
  ...
  ): APIPromise<SiteSearchGetIndexedDataResponse> {
   ...
   * @example
   * ```ts
   * const response = await client.cms.siteSearch.search();
   * ```
   */
  search(
    query: SiteSearchSearchParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<SiteSearchSearchResponse> {
 ...
 */
export interface SiteSearchGetIndexedDataResponse {
  /**
   ...
   */
  fields: { [key: string]: SiteSearchGetIndexedDataResponse.Fields };
...
export namespace SiteSearchGetIndexedDataResponse {
...
export interface SiteSearchSearchResponse {
  limit: number;
  ...
  results: Array<SiteSearchSearchResponse.Result>;
...
export namespace SiteSearchSearchResponse {
  /**
