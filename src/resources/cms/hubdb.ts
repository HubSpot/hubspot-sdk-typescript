...
export class Hubdb extends APIResource {
   ...
   */
  create(body: HubdbCreateParams, options?: RequestOptions): APIPromise<HubDBTableV3> {
   ...
   */
  list(
    query: HubdbListParams | null | undefined = {},
   ...
   */
  deleteDraft(rowID: string, params: HubdbDeleteDraftParams, options?: RequestOptions): APIPromise<void> {
  ...
  deleteVersion(
    versionID: number,
    params: HubdbDeleteVersionParams,
    options?: RequestOptions,
  ): APIPromise<void> {
    const { tableIdOrName } = params;
  ...
  export(
    tableIDOrName: string,
    query: HubdbExportParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<Response> {
  ...
  exportDraft(
    tableIDOrName: string,
    query: HubdbExportDraftParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<Response> {
  ...
  get(
    tableIDOrName: string,
    query: HubdbGetParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<HubDBTableV3> {
  ...
  getDraft(
    tableIDOrName: string,
    query: HubdbGetDraftParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<HubDBTableV3> {
  ...
  importDraft(
    tableIDOrName: string,
    body: HubdbImportDraftParams | null | undefined = {},
    options?: RequestOptions,
  ...
  listDraft(
    tableIDOrName: string,
    query: HubdbListDraftParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<UnifiedCollectionResponseWithTotalBaseHubDBTableRowV3> {
   ...
   */
  listDrafts(
    query: HubdbListDraftsParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<CollectionResponseWithTotalHubDBTableV3ForwardPaging> {
    return this._client.get('/cms/v3/hubdb/tables/draft', { query, ...options });
  }
  ...
  publishDraft(
    tableIDOrName: string,
    params: HubdbPublishDraftParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<HubDBTableV3> {
   ...
   */
  purgeBatch(tableIDOrName: string, body: HubdbPurgeBatchParams, options?: RequestOptions): APIPromise<void> {
  ...
  readDraftBatch(
    tableIDOrName: string,
    body: HubdbReadDraftBatchParams,
    options?: RequestOptions,
  ): APIPromise<BatchResponseHubDBTableRowV3> {
  ...
  replaceDraft(
    rowID: string,
    params: HubdbReplaceDraftParams,
    options?: RequestOptions,
  ): APIPromise<HubDBTableRowV3> {
  ...
  resetDraft(
    tableIDOrName: string,
    params: HubdbResetDraftParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<HubDBTableV3> {
    const { includeForeignIds } = params ?? {};
  ...
  unpublish(
    tableIDOrName: string,
    params: HubdbUnpublishParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<HubDBTableV3> {
    const { includeForeignIds } = params ?? {};
...
export interface HubdbCreateParams {
  /**
   * Label of the table
   */
  label: string;
...
export interface HubdbListParams {
  /**
...
export interface HubdbCloneBatchParams {
  inputs: Array<HubDBTableRowBatchCloneRequest>;
}

export interface HubdbCloneDraftParams {
  /**
   * Specifies whether to copy the rows during clone
   */
  copyRows: boolean;
...
export interface HubdbCreateBatchParams {
  inputs: Array<HubDBTableRowV3Request>;
}
...
export interface HubdbDeleteDraftParams {
  /**
...
export interface HubdbDeleteVersionParams {
  tableIdOrName: string;
}

export interface HubdbExportParams {
  /**
...
export interface HubdbExportDraftParams {
  /**
   * The file format to export. Possible values include `CSV`, `XLSX`, and `XLS`.
   */
  format?: string;
...
export interface HubdbGetParams {
  /**
...
export interface HubdbGetDraftParams {
  /**
...
export interface HubdbImportDraftParams {
  config?: string;
...
export interface HubdbListDraftParams {
  /**
   * The cursor token value to get the next set of results. You can get this from the
   * `paging.next.after` JSON property of a paged response containing more results.
   */
...
export interface HubdbListDraftsParams {
  /**
   * The cursor token value to get the next set of results. You can get this from the
   * `paging.next.after` JSON property of a paged response containing more results.
   */
...
export interface HubdbPublishDraftParams {
  /**
...
export interface HubdbPurgeBatchParams {
  /**
   * Strings to input.
   */
  inputs: Array<string>;
...
export interface HubdbReadBatchParams {
  /**
   * Strings to input.
   */
  inputs: Array<string>;
...
export interface HubdbReadDraftBatchParams {
  /**
   * Strings to input.
   */
  inputs: Array<string>;
...
export interface HubdbReplaceBatchParams {
  inputs: Array<HubDBTableRowV3BatchUpdateRequest>;
}

export interface HubdbReplaceDraftParams {
  /**
   * Path param: The ID or name of the table
   */
  tableIdOrName: string;
...
export interface HubdbResetDraftParams {
  /**
   * Set this to `true` to populate foreign ID values in the response.
   */
  includeForeignIds?: boolean;
...
export interface HubdbUnpublishParams {
  /**
   * Set this to `true` to populate foreign ID values in the response.
   */
  includeForeignIds?: boolean;
...
export interface HubdbUpdateBatchParams {
  inputs: Array<HubDBTableRowV3BatchUpdateRequest>;
}

export interface HubdbUpdateDraftParams {
  /**
