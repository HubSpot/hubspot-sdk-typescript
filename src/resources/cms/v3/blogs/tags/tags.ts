...
import {
  ...
  MultiLanguageUpdateSetNewLangPrimaryParams,
} from './multi-language';
...
export class Tags extends APIResource {
   ...
   */
  create(body: TagCreateParams, options?: RequestOptions): APIPromise<BlogsTagsTag> {
   ...
   * Update a Blog Tag
   */
  update(objectID: string, params: TagUpdateParams, options?: RequestOptions): APIPromise<BlogsTagsTag> {
...
Tags.MultiLanguage = MultiLanguage;
Tags.Batch = Batch;
