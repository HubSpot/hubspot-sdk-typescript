...
export declare namespace Cms {
  ...
  export {
    ...
    type SiteSearchGetIndexedDataResponse as SiteSearchGetIndexedDataResponse,
    type SiteSearchSearchResponse as SiteSearchSearchResponse,
