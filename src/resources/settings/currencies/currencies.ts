...
export class Currencies extends APIResource {
   ...
   * @example
   * ```ts
   * const collectionResponseExchangeRateForwardPaging =
   *   await client.settings.currencies.listExchangeRates();
   * ```
   */
  listExchangeRates(options?: RequestOptions): APIPromise<CollectionResponseExchangeRateForwardPaging> {
    return this._client.get('/settings/v3/currencies/exchange-rates', options);
  }
