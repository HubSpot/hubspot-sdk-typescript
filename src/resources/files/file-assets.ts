...
export class BaseFileAssets extends APIResource {
   ...
   * Creates a folder.
   */
  create(body: FileAssetCreateParams, options?: RequestOptions): APIPromise<FilesAPI.Folder> {
   ...
   */
  update(fileID: string, body: FileAssetUpdateParams, options?: RequestOptions): APIPromise<FilesAPI.File> {
  ...
  get(
    fileID: string,
    query: FileAssetGetParams | null | undefined = {},
  ...
  getSignedURL(
    fileID: string,
    query: FileAssetGetSignedURLParams | null | undefined = {},
    options?: RequestOptions,
   ...
   */
  importFromURLAsync(
    body: FileAssetImportFromURLAsyncParams,
    options?: RequestOptions,
  ...
  replace(
    fileID: string,
    body: FileAssetReplaceParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<FilesAPI.File> {
   ...
   */
  search(
    query: FileAssetSearchParams | null | undefined = {},
    options?: RequestOptions,
   ...
   */
  upload(
    body: FileAssetUploadParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<FilesAPI.File> {
...
export interface FileAssetUpdateParams {
...
export interface FileAssetGetSignedURLParams {
...
export interface FileAssetImportFromURLAsyncParams {
  /**
...
export interface FileAssetReplaceParams {
  charsetHunch?: string;
...
export interface FileAssetSearchParams extends PageParams {
...
export interface FileAssetUploadParams {
  charsetHunch?: string;
...
export declare namespace FileAssets {
  export {
