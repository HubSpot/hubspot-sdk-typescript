...
import { StatisticGetHistogramParams, StatisticGetParams, Statistics } from './statistics';
...
export class Emails extends APIResource {
   ...
   * @example
   * ```ts
   * const publicEmail = await client.marketing.emails.get(
   *   'emailId',
   * );
   * ```
   */
   ...
   *   await client.marketing.emails.getRevision('revisionId', {
   *     emailId: 'emailId',
   *   });
   * ```
   */
   ...
   * ```ts
   * const publicEmail =
   *   await client.marketing.emails.restoreRevisionToDraft(0, {
   *     emailId: 'emailId',
   *   });
   * ```
   */
   ...
   * ```ts
   * const publicEmail =
   *   await client.marketing.emails.updateDraft('emailId');
   * ```
   */
  updateDraft(
    emailID: string,
