...
export class Associations extends APIResource {
   ...
   *   await client.marketing.marketingEvents.associations.list(
   *     'marketingEventId',
   *   );
   * ```
   */
  ...
  ): APIPromise<MarketingEventsAPI.CollectionResponseWithTotalPublicListNoPaging> {
   ...
   * @example
   * ```ts
   * await client.marketing.marketingEvents.associations.delete(
   *   'listId',
   ...
   * @example
   * ```ts
   * await client.marketing.marketingEvents.associations.associate(
   *   'listId',
   *   { marketingEventId: 'marketingEventId' },
   * );
   * ```
   ...
   * @example
   * ```ts
   * await client.marketing.marketingEvents.associations.associateByExternalAccount(
   *   'listId',
   *   {
   ...
   * @example
   * ```ts
   * await client.marketing.marketingEvents.associations.deleteByExternalAccount(
   *   'listId',
   *   {
   *     externalAccountId: 'externalAccountId',
   *     externalEventId: 'externalEventId',
   ...
   * ```ts
   * const collectionResponseWithTotalPublicListNoPaging =
   *   await client.marketing.marketingEvents.associations.listByExternalAccount(
   *     'externalEventId',
   *     { externalAccountId: 'externalAccountId' },
   *   );
   * ```
