...
import { BaseHubSpot, ClientOptions } from './client';
import { APIResource } from './core/resource';
import { hasOwn } from './internal/utils/values';

export type PartialHubSpot<T extends MaybeResource> = BaseHubSpot & T;
...
): PartialHubSpot<InferClientStructure<T>> {
  const client = new BaseHubSpot(options);
