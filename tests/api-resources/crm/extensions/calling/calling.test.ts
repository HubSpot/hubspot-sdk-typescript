...
import { BaseCalling } from '@hubspot/sdk/resources/crm/extensions/calling/calling';
...
const runTests = (client: PartialHubSpot<{ crm: { extensions: { calling: BaseCalling } } }>) => {
...
describe('resource calling', () => runTests(client));
describe('resource calling (tree shakable, base)', () => runTests(partialClient));
describe('resource calling (tree shakable, subresource)', () => runTests(parentPartialClient));
