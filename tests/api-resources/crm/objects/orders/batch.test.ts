...
import { BaseBatch } from '@hubspot/sdk/resources/crm/objects/orders/batch';
import { Orders } from '@hubspot/sdk/resources/crm/objects/orders/orders';
...
const runTests = (client: PartialHubSpot<{ crm: { objects: { orders: { batch: BaseBatch } } } }>) => {
