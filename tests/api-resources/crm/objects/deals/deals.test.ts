...
import { BaseDeals } from '@hubspot/sdk/resources/crm/objects/deals/deals';
...
const runTests = (client: PartialHubSpot<{ crm: { objects: { deals: BaseDeals } } }>) => {
  // Mock server tests are disabled
  test.skip('create: only required params', async () => {
    const responsePromise = client.crm.objects.deals.create({
      associations: [
        {
          to: { id: 'id' },
  ...
  // Mock server tests are disabled
  test.skip('get', async () => {
    const responsePromise = client.crm.objects.deals.get('dealId');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('search: required and optional params', async () => {
    const response = await client.crm.objects.deals.search({
      after: 'after',
      filterGroups: [
        {
          filters: [
...
describe('resource deals', () => runTests(client));
describe('resource deals (tree shakable, base)', () => runTests(partialClient));
describe('resource deals (tree shakable, subresource)', () => runTests(parentPartialClient));
