...
import { BaseBatch } from '@hubspot/sdk/resources/crm/objects/deals/batch';
import { Deals } from '@hubspot/sdk/resources/crm/objects/deals/deals';
...
const runTests = (client: PartialHubSpot<{ crm: { objects: { deals: { batch: BaseBatch } } } }>) => {
