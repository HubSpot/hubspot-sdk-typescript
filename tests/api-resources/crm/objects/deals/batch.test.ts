...
describe('resource batch', () => {
  ...
  test.skip('delete: only required params', async () => {
    const responsePromise = client.crm.objects.deals.batch.delete({ inputs: [{ id: 'id' }] });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('delete: required and optional params', async () => {
    const response = await client.crm.objects.deals.batch.delete({ inputs: [{ id: 'id' }] });
  });

  // Prism tests are disabled
  test.skip('read: only required params', async () => {
    const responsePromise = client.crm.objects.deals.batch.read({
      inputs: [{ id: 'id' }],
      properties: ['string'],
  ...
  test.skip('read: required and optional params', async () => {
    const response = await client.crm.objects.deals.batch.read({
      inputs: [{ id: 'id' }],
      properties: ['string'],
      propertiesWithHistory: ['string'],
      archived: true,
