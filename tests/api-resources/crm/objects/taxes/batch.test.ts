...
import { BaseBatch } from 'hubspot-sdk/resources/crm/objects/taxes/batch';
import { Taxes } from 'hubspot-sdk/resources/crm/objects/taxes/taxes';
...
const runTests = (client: PartialHubSpot<{ crm: { objects: { taxes: { batch: BaseBatch } } } }>) => {
