...
import { BaseBatch } from 'hubspot-sdk/resources/crm/objects/custom/batch';
import { Custom } from 'hubspot-sdk/resources/crm/objects/custom/custom';
...
const runTests = (client: PartialHubSpot<{ crm: { objects: { custom: { batch: BaseBatch } } } }>) => {
