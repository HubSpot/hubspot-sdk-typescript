...
import { BaseBatch } from 'hubspot-sdk/resources/crm/objects/feedback-submissions/batch';
import { FeedbackSubmissions } from 'hubspot-sdk/resources/crm/objects/feedback-submissions/feedback-submissions';
...
const parentPartialClient = createClient({
  accessToken: 'My Access Token',
  baseURL: process.env['TEST_API_BASE_URL'] ?? 'http://127.0.0.1:4010',
  resources: [FeedbackSubmissions],
});

const runTests = (
  client: PartialHubSpot<{ crm: { objects: { feedbackSubmissions: { batch: BaseBatch } } } }>,
) => {
