...
import { BaseSubscriptions } from '@hubspot/sdk/resources/crm/objects/subscriptions/subscriptions';
...
const runTests = (client: PartialHubSpot<{ crm: { objects: { subscriptions: BaseSubscriptions } } }>) => {
