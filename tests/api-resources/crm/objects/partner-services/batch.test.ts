...
import { BaseBatch } from '@hubspot/sdk/resources/crm/objects/partner-services/batch';
import { PartnerServices } from '@hubspot/sdk/resources/crm/objects/partner-services/partner-services';
...
const parentPartialClient = createClient({
  accessToken: 'My Access Token',
  baseURL: process.env['TEST_API_BASE_URL'] ?? 'http://127.0.0.1:4010',
  resources: [PartnerServices],
});

const runTests = (
  client: PartialHubSpot<{ crm: { objects: { partnerServices: { batch: BaseBatch } } } }>,
) => {
