...
import { BaseInvoices } from 'hubspot-sdk/resources/crm/objects/invoices/invoices';
...
const runTests = (client: PartialHubSpot<{ crm: { objects: { invoices: BaseInvoices } } }>) => {
  ...
  test.skip('update: only required params', async () => {
    const responsePromise = client.crm.objects.invoices.update('invoiceId', {
      properties: { foo: 'string' },
    });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
  ...
  test.skip('update: required and optional params', async () => {
    const response = await client.crm.objects.invoices.update('invoiceId', {
      properties: { foo: 'string' },
  ...
  test.skip('delete', async () => {
    const responsePromise = client.crm.objects.invoices.delete('invoiceId');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  // Mock server tests are disabled
  test.skip('get', async () => {
    const responsePromise = client.crm.objects.invoices.get('invoiceId');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
