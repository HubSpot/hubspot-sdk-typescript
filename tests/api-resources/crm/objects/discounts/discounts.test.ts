...
import { BaseDiscounts } from 'hubspot-sdk/resources/crm/objects/discounts/discounts';
...
const runTests = (client: PartialHubSpot<{ crm: { objects: { discounts: BaseDiscounts } } }>) => {
...
describe('resource discounts', () => runTests(client));
describe('resource discounts (tree shakable, base)', () => runTests(partialClient));
describe('resource discounts (tree shakable, subresource)', () => runTests(parentPartialClient));
