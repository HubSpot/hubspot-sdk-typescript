...
import { BaseBatch } from 'hubspot-sdk/resources/cms/blogs/tags/batch';
import { Tags } from 'hubspot-sdk/resources/cms/blogs/tags/tags';
...
const runTests = (client: PartialHubSpot<{ cms: { blogs: { tags: { batch: BaseBatch } } } }>) => {
