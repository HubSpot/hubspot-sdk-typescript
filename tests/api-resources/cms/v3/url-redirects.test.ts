...
describe('resource urlRedirects', () => {
  ...
  test.skip('retrieve', async () => {
    const responsePromise = client.cms.v3.urlRedirects.retrieve('urlRedirectId');
  ...
  test.skip('update: only required params', async () => {
    const responsePromise = client.cms.v3.urlRedirects.update({
  ...
  test.skip('update: required and optional params', async () => {
    const response = await client.cms.v3.urlRedirects.update({
      destination: 'destination',
      redirectStyle: 0,
      routePrefix: 'routePrefix',
      isMatchFullUrl: true,
  ...
  test.skip('delete', async () => {
    const responsePromise = client.cms.v3.urlRedirects.delete('urlRedirectId');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  // Prism tests are disabled
  test.skip('retrieve', async () => {
    const responsePromise = client.cms.v3.urlRedirects.retrieve();
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('retrieve: request options and params are passed correctly', async () => {
    ...
    await expect(
      client.cms.v3.urlRedirects.retrieve(
        {
          after: 'after',
          archived: true,
