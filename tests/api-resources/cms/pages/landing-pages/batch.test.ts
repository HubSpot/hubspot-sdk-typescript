...
import { BaseBatch } from '@hubspot/sdk/resources/cms/pages/landing-pages/batch';
...
const runTests = (client: PartialHubSpot<{ cms: { pages: { landingPages: { batch: BaseBatch } } } }>) => {
  // Mock server tests are disabled
  test.skip('createLandingPages: only required params', async () => {
    const responsePromise = client.cms.pages.landingPages.batch.createLandingPages({
      inputs: [
        {
          id: 'id',
  ...
  test.skip('createLandingPages: required and optional params', async () => {
    const response = await client.cms.pages.landingPages.batch.createLandingPages({
      inputs: [
        {
          id: 'id',
          abStatus: 'automated_loser_variant',
  ...
  test.skip('deleteLandingPages: only required params', async () => {
    const responsePromise = client.cms.pages.landingPages.batch.deleteLandingPages({ inputs: ['string'] });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('deleteLandingPages: required and optional params', async () => {
    const response = await client.cms.pages.landingPages.batch.deleteLandingPages({ inputs: ['string'] });
  });

  // Mock server tests are disabled
  test.skip('getLandingPages: only required params', async () => {
    const responsePromise = client.cms.pages.landingPages.batch.getLandingPages({ inputs: ['string'] });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('getLandingPages: required and optional params', async () => {
    const response = await client.cms.pages.landingPages.batch.getLandingPages({
      inputs: ['string'],
      archived: true,
    });
  });
  ...
  test.skip('updateLandingPages: only required params', async () => {
    const responsePromise = client.cms.pages.landingPages.batch.updateLandingPages({ inputs: [{}] });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('updateLandingPages: required and optional params', async () => {
    const response = await client.cms.pages.landingPages.batch.updateLandingPages({
      inputs: [{}],
      archived: true,
    });
  });
