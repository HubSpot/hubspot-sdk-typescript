...
import { BaseSitePages } from '@hubspot/sdk/resources/cms/pages/site-pages/site-pages';
...
const runTests = (client: PartialHubSpot<{ cms: { pages: { sitePages: BaseSitePages } } }>) => {
...
describe('resource sitePages', () => runTests(client));
describe('resource sitePages (tree shakable, base)', () => runTests(partialClient));
describe('resource sitePages (tree shakable, subresource)', () => runTests(parentPartialClient));
