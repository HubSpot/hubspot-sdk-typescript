...
import { BaseDraft } from '@hubspot/sdk/resources/cms/pages/site-pages/draft';
...
const runTests = (client: PartialHubSpot<{ cms: { pages: { sitePages: { draft: BaseDraft } } } }>) => {
  // Mock server tests are disabled
  test.skip('getDraft', async () => {
    const responsePromise = client.cms.pages.sitePages.draft.getDraft('objectId');
  ...
  test.skip('publishDraft', async () => {
    const responsePromise = client.cms.pages.sitePages.draft.publishDraft('objectId');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('resetSitePageDraft', async () => {
    const responsePromise = client.cms.pages.sitePages.draft.resetSitePageDraft('objectId');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('updateDraft: only required params', async () => {
    const responsePromise = client.cms.pages.sitePages.draft.updateDraft('objectId', {
      id: 'id',
  ...
  test.skip('updateDraft: required and optional params', async () => {
    const response = await client.cms.pages.sitePages.draft.updateDraft('objectId', {
      id: 'id',
      abStatus: 'automated_loser_variant',
      abTestId: 'abTestId',
      archivedAt: '2019-12-27T18:11:19.117Z',
