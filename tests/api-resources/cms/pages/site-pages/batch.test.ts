...
import { BaseBatch } from '@hubspot/sdk/resources/cms/pages/site-pages/batch';
...
const runTests = (client: PartialHubSpot<{ cms: { pages: { sitePages: { batch: BaseBatch } } } }>) => {
  // Mock server tests are disabled
  test.skip('createSitePages: only required params', async () => {
    const responsePromise = client.cms.pages.sitePages.batch.createSitePages({
      inputs: [
        {
          id: 'id',
  ...
  test.skip('createSitePages: required and optional params', async () => {
    const response = await client.cms.pages.sitePages.batch.createSitePages({
      inputs: [
        {
          id: 'id',
          abStatus: 'automated_loser_variant',
  ...
  test.skip('deleteSitePages: only required params', async () => {
    const responsePromise = client.cms.pages.sitePages.batch.deleteSitePages({ inputs: ['string'] });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('deleteSitePages: required and optional params', async () => {
    const response = await client.cms.pages.sitePages.batch.deleteSitePages({ inputs: ['string'] });
  });

  // Mock server tests are disabled
  test.skip('getSitePages: only required params', async () => {
    const responsePromise = client.cms.pages.sitePages.batch.getSitePages({ inputs: ['string'] });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('getSitePages: required and optional params', async () => {
    const response = await client.cms.pages.sitePages.batch.getSitePages({
      inputs: ['string'],
      archived: true,
    });
  });
  ...
  test.skip('updateSitePages: only required params', async () => {
    const responsePromise = client.cms.pages.sitePages.batch.updateSitePages({ inputs: [{}] });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('updateSitePages: required and optional params', async () => {
    const response = await client.cms.pages.sitePages.batch.updateSitePages({ inputs: [{}], archived: true });
  });
};
