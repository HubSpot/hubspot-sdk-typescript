...
import { BaseMultiLanguage } from '@hubspot/sdk/resources/cms/pages/site-pages/multi-language';
...
const runTests = (
  client: PartialHubSpot<{ cms: { pages: { sitePages: { multiLanguage: BaseMultiLanguage } } } }>,
) => {
  ...
  test.skip('createLanguageVariation: only required params', async () => {
    const responsePromise = client.cms.pages.sitePages.multiLanguage.createLanguageVariation({ id: 'id' });
  ...
  test.skip('createLanguageVariation: required and optional params', async () => {
    const response = await client.cms.pages.sitePages.multiLanguage.createLanguageVariation({
      id: 'id',
      language: 'language',
  ...
  test.skip('setNewLangPrimary: only required params', async () => {
    const responsePromise = client.cms.pages.sitePages.multiLanguage.setNewLangPrimary({ id: 'id' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('setNewLangPrimary: required and optional params', async () => {
    const response = await client.cms.pages.sitePages.multiLanguage.setNewLangPrimary({ id: 'id' });
  });
