...
import { BaseURLRedirects } from '@hubspot/sdk/resources/cms/url-redirects';
...
const runTests = (client: PartialHubSpot<{ cms: { urlRedirects: BaseURLRedirects } }>) => {
...
describe('resource urlRedirects', () => runTests(client));
describe('resource urlRedirects (tree shakable, base)', () => runTests(partialClient));
describe('resource urlRedirects (tree shakable, subresource)', () => runTests(parentPartialClient));
