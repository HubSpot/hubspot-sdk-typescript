...
describe('resource meetingsLinks', () => {
  ...
  // Prism tests are disabled
  test.skip('getInitialBookingInfo', async () => {
    const responsePromise = client.scheduler.meetings.meetingsLinks.getInitialBookingInfo('slug');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  // Prism tests are disabled
  test.skip('getNextAvailability', async () => {
    const responsePromise = client.scheduler.meetings.meetingsLinks.getNextAvailability('slug');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
