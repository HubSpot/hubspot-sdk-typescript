...
describe('resource reports', () => {
  ...
  test.skip('getAttributionMetrics', async () => {
    const responsePromise = client.marketing.campaigns.reports.getAttributionMetrics('campaignGuid');
  ...
  test.skip('getAttributionMetrics: request options and params are passed correctly', async () => {
    ...
    await expect(
      client.marketing.campaigns.reports.getAttributionMetrics(
        'campaignGuid',
  ...
  test.skip('getRevenueAttribution', async () => {
    const responsePromise = client.marketing.campaigns.reports.getRevenueAttribution('campaignGuid');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('listContactIDsByType: only required params', async () => {
    const responsePromise = client.marketing.campaigns.reports.listContactIDsByType('contactType', {
  ...
  test.skip('listContactIDsByType: required and optional params', async () => {
    const response = await client.marketing.campaigns.reports.listContactIDsByType('contactType', {
      campaignGuid: 'campaignGuid',
      after: 'after',
      endDate: 'endDate',
      limit: 0,
