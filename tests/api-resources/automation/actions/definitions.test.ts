...
import { BaseDefinitions } from '@hubspot/sdk/resources/automation/actions/definitions';
...
const runTests = (client: PartialHubSpot<{ automation: { actions: { definitions: BaseDefinitions } } }>) => {
