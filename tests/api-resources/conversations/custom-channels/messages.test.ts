...
describe('resource messages', () => {
  ...
  test.skip('updateStatus: only required params', async () => {
    const responsePromise = client.conversations.customChannels.messages.updateStatus('messageId', {
      channelId: 'channelId',
      statusType: 'SENT',
    });
    const rawResponse = await responsePromise.asResponse();
  ...
  test.skip('updateStatus: required and optional params', async () => {
    const response = await client.conversations.customChannels.messages.updateStatus('messageId', {
      channelId: 'channelId',
      statusType: 'SENT',
